            ...
            <div className="col-md-4 animated fadeIn" key={data.id}>
              <div className="card">
                <div className="card-body">
                  ...
                  <p className='cart-text' style={{marginLeft:"0%",width:"21vmin",height:"21vmin",marginTop:"20px", wordWrap: "break-word", fontSize: "2.0vmin",whiteSpace: "normal"}}>About:
                {data.description }
                  </p>
                  </div>
                  </div>
              ...
              <div className={classes.userlink}>
                ...
                <tbody>
                { userChannel && userChannel.map((channel ,index,tag) => {    
                 return(
                 <tr key={index}>
                 <td >
                 - {channel}</td>
