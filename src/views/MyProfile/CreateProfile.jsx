...
const onChannelChanged=(e,channelFieldKey,tag)=>{
  ...
  if(validateForm()){
    if(localStorage.getItem('channelStrkey')&&localStorage.getItem('channelStrId')){
      let data = {
        "records": [
          {
            "fields": {
              ...
              userChannelTag:formInput.userChannelName.toLowerCase().replace(/\s/g, ''), 
    ...
    <BasicLayout home>
      ...
      <Paper className={classes.root}>
        ...
        {channel.title}</td>
         ...
         Upload Profile Image: <br></br><br></br>
            ...
            />
        {state.selectedFile&&( <img src={state.selectedFile}width="5%"/>)}
       <br></br>
       <br></br>
         </div>
            <Fragment>
      ...
      <br></br>
         ...
         Upload Channel Image: <br></br><br></br>
            ...
            />
        {formInput.userChannelImage&&( <img src={URL.createObjectURL(formInput.userChannelImage)}width="5%"/>)}
       <br></br>
       <br></br>
         </div>
          <br></br>
