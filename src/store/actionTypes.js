...
export const HIDE_AUDIO_CONTROLS = 'HIDE_AUDIO_CONTROLS'
...
export const SHOW_AUDIO_CONTROLS = 'SHOW_AUDIO_CONTROLS'
export const SHOW_NAV = 'SHOW_NAV'
export const SET_FRIENDS_LIST = 'SET_FRIENDS_LIST'
export const SET_CHANNEL_LIST = 'SET_CHANNEL_LIST'
export const SET_CREATOR_LIST = 'SET_CREATOR_LIST'
